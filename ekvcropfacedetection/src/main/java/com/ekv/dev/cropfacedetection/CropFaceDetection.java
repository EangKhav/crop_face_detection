...
package com.ekv.dev.cropfacedetection;
...
public class CropFaceDetection {
     ...
     * @param bitmap
     */
    private CropFaceDetection(Context context, Bitmap bitmap) {
     ...
     */
    public static synchronized CropFaceDetection initialize(Context context, Bitmap bitmap) {
        return new CropFaceDetection(context, bitmap);
    }
